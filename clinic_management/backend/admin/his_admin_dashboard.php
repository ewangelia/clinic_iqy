                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Clinic Information System Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM users WHERE level_user IN (1,2) ";
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM users WHERE level_user IN (1,2)  ORDER BY RAND() LIMIT 10 "; 
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->no_user;?>
                                                    </td>
                                                    <td>
                                                        <a href="his_admin_view_single_employee.php?id_user=<?php echo $row->id_user;?>&&dno_user=<?php echo $row->no_user;?>" class="btn btn-xs btn-primary"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
