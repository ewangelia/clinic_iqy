                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_patient.php?id_user=<?php echo $row->id_user;?>&&no_user=<?php echo $row->no_user;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
